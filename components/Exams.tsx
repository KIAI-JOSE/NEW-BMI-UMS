...
const Exams: React.FC = () => {
  ...
  const upcomingExams: ExamRecord[] = [
    ...
    { id: 'EX-902', course: 'Introduction to Web Dev', code: 'CS101', date: '2024-06-14', time: '02:00 PM', venue: 'Lab 204', proctor: 'Prof. Mwangi', status: 'Papers Processing', level: 'Degree' },
    { id: 'EX-903', course: 'Counseling Ethics', code: 'MDIV550', date: '2024-06-15', time: '11:00 AM', venue: 'Room 12B', proctor: 'Rev. Omolo', status: 'Scheduled', level: 'Masters' },
    { id: 'EX-904', course: 'Biblical Hermeneutics', code: 'THEO200', date: '2024-06-18', time: '08:30 AM', venue: 'Bethlehem Hall', proctor: 'Dr. Jane Okumu', status: 'Scheduled', level: 'Diploma' },
  ];

  const rawGradeData = [
    { id: 'GR-001', student: 'Aaron Keitany', studentId: 'BMI-2022-001', course: 'Systematic Theology I', midterm: 88, final: 92, status: 'Verified', level: 'Degree' },
    { id: 'GR-002', student: 'Beatrice Wanjiku', studentId: 'BMI-2023-012', course: 'Intro to ICT', midterm: 75, final: 82, status: 'Verified', level: 'Degree' },
    { id: 'GR-003', student: 'Caleb Rotich', studentId: 'BMI-2023-045', course: 'Biblical Greek', midterm: 92, final: 95, status: 'Verified', level: 'Diploma' },
    { id: 'GR-004', student: 'Diana Waweru', studentId: 'BMI-2022-088', course: 'Strategic Business', midterm: 62, final: 55, status: 'Flagged', level: 'Degree' },
    { id: 'GR-005', student: 'Edward Lowasa', studentId: 'BMI-2023-102', course: 'Systematic Theology I', midterm: 78, final: 81, status: 'Pending Review', level: 'Masters' },
    { id: 'GR-006', student: 'Faith Chepkirui', studentId: 'BMI-2023-055', course: 'Education Pedagogy', midterm: 85, final: 88, status: 'Verified', level: 'PhD' },
  ];
  ...
  const filteredExams = upcomingExams.filter(ex => {
    ...
    const matchesLevel = academicLevelFilter === 'All Levels' || ex.level === academicLevelFilter;
    const matchesSubject = selectedSubject === 'All Subjects' || ex.course === selectedSubject;
    ...
    <div className="bg-white dark:bg-gray-800 p-6 border border-gray-100 dark:border-gray-700 shadow-sm mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
                <label className="text-[9px] font-black uppercase text-gray-400 tracking-widest">Select Program / Course</label>
                <select 
            ...
            <div className="space-y-1">
                <label className="text-[9px] font-black uppercase text-gray-400 tracking-widest">Select Subject Unit</label>
                <select 
                ...
                >
                    ...
                    {[...new Set([...upcomingExams.map(e => e.course), ...rawGradeData.map(g => g.course)])].sort().map(c => (
